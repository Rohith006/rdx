    ...
    <TuiForm style={{ margin: 20 }}>
      <TuiFormGroup>
        ...
        <TuiFormGroupContent>
          <TuiFormGroupField
            header="Event type"
            description="Bind this segment event type. You can select
          ...
          <TuiFormGroupField
            header="Condition"
            description="Segments are created after the event is processed.
          ...
          >
            <TextField
              ...
              rows={3}
              error={
                typeof conditionErrorMessage !== "undefined" &&
              ...
              helperText={
                <p className="helper_error">
                  {conditionErrorMessage
                    ? conditionErrorMessage
                    : "Condition example: profile@stats.visits>10 AND profile@traits.public.boughtProducts>1"}
                </p>
              }
              onChange={(ev) => {
          ...
          <TuiFormGroupField
            header="Activation"
            description="Set if this segment is active. "
          >
      ...
      <TuiFormGroup>
        ...
        <TuiFormGroupContent>
          <TuiFormGroupField
            header="Name"
            description="The segment name will be its id, after spaces are
