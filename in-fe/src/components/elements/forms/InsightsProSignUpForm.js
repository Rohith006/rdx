...
import {
  asyncRemote,
  covertErrorIntoObject,
  getError,
} from "../../../remote_api/entrypoint";
...
export default function InsightsProSignUpForm({ onSubmit, onCancel }) {
  ...
  const handleRegisterInsightsPro = async () => {
    try {
      setFieldErrors({});
      setError(false);
      setLoading(true);
  ...
  const step1 = () => (
    <TuiForm style={{ maxWidth: 500 }}>
      <TuiFormGroup>
        <TuiFormGroupHeader
          header="Insights Pro Registration"
          description="Sing-up to Insights Pro services."
        />
        ...
        <TuiFormGroupContent>
          <TuiFormGroupContent>
            ...
            <TuiFormGroupField
              header="Company name or your name"
  ...
  const step2 = () => (
    <TuiForm style={{ maxWidth: 500 }}>
      <TuiFormGroup>
        ...
        <TuiFormGroupContent>
          <TuiFormGroupContent>
            <TuiFormGroupField
              header="Service Host"
              description="Please any of the available service Hosts."
            >
              <TextField
                label="Insights Pro Server Host"
                value={data.host}
                onChange={(ev) => {
              ...
              <TuiColumnsFlex width={200} style={{ marginTop: 20 }}>
                ...
                >
                  <TextField
                    ...
                    helperText={
                      "username" in fieldErrors && fieldErrors["username"]
                    }
                    variant="outlined"
                    required={true}
                  />
                ...
                >
                  <TextField
                    ...
                    helperText={
                      "password" in fieldErrors && fieldErrors["password"]
                    }
                    variant="outlined"
                    required={true}
                  />
      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <Button
          label="Sign-up"
          onClick={handleRegisterInsightsPro}
          style={{ padding: "6px 10px", justifyContent: "center" }}
          progress={loading}
        />
      </div>
