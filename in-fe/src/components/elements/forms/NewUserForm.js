    ...
    <TuiForm style={{ padding: 20 }}>
      <TuiFormGroup>
        ...
        <TuiFormGroupContent>
          <TuiFormGroupField
            header="E-mail"
            description="Please type the e-mail address of the new user."
          >
            <TextField
              fullWidth
              variant="outlined"
              ...
              error={!email && error}
              helperText={
                !email && error && <ErrorLine>Email cannot be empty</ErrorLine>
              }
            />
          </TuiFormGroupField>
          <TuiFormGroupField
            header="Password"
            description="Type new user's password."
          >
            <PasswordInput
              fullWidth
              variant="outlined"
              ...
              helperText={
                !password &&
                error && <ErrorLine>Password cannot be empty</ErrorLine>
              }
            />
          </TuiFormGroupField>
          <TuiFormGroupField
            header="Confirm password"
            description="Please retype the password for confirmation that it is correct."
          >
            <PasswordInput
              fullWidth
              variant="outlined"
          ...
          <TuiFormGroupField
            header="Full name"
            description="Please type in the name and surname of the new user."
          >
            <TextField
              fullWidth
              variant="outlined"
      ...
      <TuiFormGroup>
        <TuiFormGroupHeader
          ...
          description="User account can be turned off with this switch. The account information will not be erased."
        />
        <TuiFormGroupField>
          <FormControlLabel
            style={{ padding: 10, marginLeft: 10 }}
