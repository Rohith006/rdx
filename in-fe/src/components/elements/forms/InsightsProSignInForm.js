...
export default function InsightsProSignInForm({ onSubmit, onCancel }) {
  ...
  return (
    <TuiForm style={{ maxWidth: 500 }}>
      <TuiFormGroup>
        <TuiFormGroupHeader
          header="Insights Pro Sign In"
          description="Sing-in to Insights Pro services."
        />
        {error && <ErrorsBox errorList={error} style={{ borderRadius: 0 }} />}
        {accessDenied && (
          <AlertBox>
            Access denied. Please check your e-mail and password.
          </AlertBox>
        )}
        <TuiFormGroupContent>
          <TuiFormGroupContent>
