        ...
        <div>
          ...
          >
            <div className="NeedHelpButton">
              <div>
                Mention us on Twitter @twitter. We will respond as quickly as
                possible.
                <Button
                  label="Twitter"
              ...
              <div>
                ...
                <Button
                  ...
                  onClick={external(
                    "https://www.youtube.com/channel/UC0atjYqW43MdqNiSJBvN__Q",
                    true
                  )}
                  style={{ justifyContent: "center", marginTop: 10 }}
                ></Button>
              ...
              <div>
                Need help from the community? Join our public Slack channel! We
                are happy to help.
                <Button
                  label="Join slack channel"
                  icon={<AiOutlineSlack size={20} />}
                  onClick={external(
                    "https://join.slack.com/t/Tracardi/shared_invite/zt-10y7w0o9y-PmCBnK9qywchmd1~KIER2Q",
                    true
                  )}
                  style={{ justifyContent: "center", marginTop: 10 }}
                ></Button>
