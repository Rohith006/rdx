...
const TrackerScript = ({ sourceId }) => {
  ...
  const [tracker] = useState(`<script>
var options = {
    tracker: {
        url: {
            // This is url to Insights backend. Please mind the correct port.
            script: '${process.env.REACT_APP_TRACKER_URL}',
