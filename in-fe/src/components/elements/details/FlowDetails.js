...
export default function FlowDetails({ id, onDeleteComplete }) {
  ...
  const onGoToDeployedFlow = (id) => {
    history.push(urlPrefix("/activate/preview/") + id);
  };
  ...
  const Details = () => (
    <TuiForm>
      <TuiFormGroup>
        <TuiFormGroupHeader
          header="Workflow"
          description="Information on workflow"
        />
        <TuiFormGroupContent>
          <TuiFormGroupField header="Data">
            ...
            <Rows style={{ marginTop: 20 }}>
              ...
              <Button
                ...
                icon={
                  <IoGitNetworkSharp size={20} style={{ marginRight: 5 }} />
                }
                label="Edit FLOW"
                disabled={typeof data === "undefined"}
              />
      ...
      <TuiFormGroup>
        <TuiFormGroupHeader
          header="Rules"
          description="List of rules connected with the workflow."
        />
        <TuiFormGroupContent>
          <TuiFormGroupField
            header="Active rules"
            description="Rules that trigger this flow"
          >
