  ...
  return (
    <>
      <div className="mb-4 text-base">
        <span className="text-neutral-text">{`${route} /`}</span>
        <span className="top-text">{` ${type}`}</span>
      </div>
      <div className="bg-white p-6 rounded-lg border border-primary-border">
        ...
        <div className="Data">
          ...
          >
            <BarChartElement
              ...
              columns={[{ label: "count", color: "#2c3550", stackId: "count" }]}
              refreshInterval={refresh}
            />
          </DataBrowsingList>
        </div>
