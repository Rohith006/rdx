...
const auth = 'Basic ' + Buffer.from(`mkMMbiiSV1jh28wBQvEt:Qx0m3sZnwW6evcrwxJW8`).toString('base64');

export const getCategoriesByAPI = () => axios.create({
  timeout: 2000,
  headers: {'Authorization': auth},
    ...
    .catch((e) => console.error('Could not get categories'));
